package org.example.event.sourcing.order.poc.client.order.decoder;

import feign.Response;
import feign.codec.ErrorDecoder;
import lombok.RequiredArgsConstructor;
import org.example.event.sourcing.order.poc.client.order.exception.BadRequestException;
import org.example.event.sourcing.order.poc.client.order.exception.ResourceNotFoundException;
import org.example.event.sourcing.order.poc.client.order.model.ResourceName;
