...
import org.example.event.sourcing.order.poc.command.payment.service.PaymentV2Service;
...
@RequestMapping(value = "api/v2/payments", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
public class PaymentV2Controller {

    private final PaymentV2Service paymentService;
