...
public class PaymentV2Service {
    ...
    public Payment createPayment(Payment payment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 create payment event fail");
        }
    }
    ...
    public Payment validatePayment(Payment payment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 payment validated event fail");
        }
    }
    ...
    public Payment confirmPayment(Payment payment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 payment confirmed event fail");
        }
    }
    ...
    public Payment cancelPayment(Payment payment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 payment canceled event fail");
        }
    }
    ...
    public Payment settlePayment(Payment payment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 payment settled event fail");
        }
    }
