...
public class ShipmentV2Service {
    ...
    public Shipment createShipment(Shipment shipment) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 create shipment event fail");
        }
    }
    ...
    public boolean prepareShipment(String shipmentId) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 prepare shipment event fail");
        }
    }
    ...
    public boolean sellerSendShipment(String shipmentId) {
        ...
        if (isSuccess) {
            ...
            throw new RuntimeException("v2 process shipment event fail");
        }
    }
